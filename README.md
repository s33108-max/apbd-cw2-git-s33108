...
Polimorfizm w klasach użytkowników: Klasy 'Student' i 'Pracownik' dziedziczą po klasie 'Osoba' i same definiują swój limit wypożyczeń poprzez nadpisanie metody 'GetMaxReservations()'.
